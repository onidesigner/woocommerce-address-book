				...
				?>
					...
					<div class="wc-address-book-address">
						<div class="wc-address-book-meta">
							<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'shipping/?address-book=' . $name ) ); ?>" class="btn-edit"><?php echo esc_attr__( 'Edit', 'wc-address-book' ); ?></a>
							<a id="<?php echo esc_attr( $name ); ?>" class="btn-delete"><?php echo esc_attr__( 'Delete', 'wc-address-book' ); ?></a>
							<a id="<?php echo esc_attr( $name ); ?>" class="btn-make-primary"><?php echo esc_attr__( 'Make Primary', 'wc-address-book' ); ?></a>
						</div>
						<address>
